...
&#13;
----------------- URL ---------------
{{ $result['full_path_with_csa'] }}
&#13;
{{ $result['relative_path'] }}
@isset($result['relative_path_zh'])
@if ($result['relative_path_zh'] !== $result['relative_path'])
{{ $result['relative_path_zh'] }}
@endif
@endisset
&#13;
{{ $result['relative_path'] }}&csa={{ $result['naming_convention'] }}
@isset($result['relative_path_zh'])
@if ($result['relative_path_zh'] !== $result['relative_path'])
{{ $result['relative_path_zh'] }}&csa={{ $result['naming_convention'] }}
@endif
@endisset
&#13;
--------------------DEEPLINK-------------------
&#13;
-------------------CSA-------------------------
@if ($result['segment'] === 'Kids')
{{ $result['event_label_kids'] }}
@elseif ($result['segment'] === "Beauty")
{{ $result['event_label_beauty'] }}
@elseif ($result['segment'] === "Luxury")
{{ $result['event_label_luxury'] }}
@elseif ($result['segment'] === "Lifestyle")
{{ $result['event_label_lifestyle'] }}
@elseif ($result['segment'] === "Women")
